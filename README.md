...
1) this lab
   ...
   AssertionError: no folder name "my-repository" was found: value: expected './my-repository' to exist
    ...
    at Function.ctx.(anonymous function) [as directory] (node_modules/chai/lib/chai/utils/addMethod.js:41:25) (node_modules/chai-fs/lib/assertions/directory.js:34:35)
    at Function.assert.isDirectory
